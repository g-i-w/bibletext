...
public class HTMLPrinter {
	...
	public HTMLPrinter ( String template ) {
		htmlTemplate = new TemplateFile( template, "////" );
	}
	
	public String eBibleText ( String path ) throws Exception {
		...
		if (!currentBook.equals("")) html.append( "</tbody>\n</table>" );
		htmlTemplate
			.replace( "title", FileActions.minName(path) )
	...
	public static void main ( String[] args ) throws Exception {
		...
		FileActions.write( args[2],
			new HTMLPrinter( args[1] ).eBibleText( args[0] )
		);
	}
